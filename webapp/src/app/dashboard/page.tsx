...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#2e2e2e] text-white flex overflow-hidden font-sans">
      ...
      {/* Sidebar */}
      <aside id="mobile-sidebar" className="fixed lg:sticky top-0 left-0 z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 w-[280px] bg-[#363636] border-r border-[#444] p-6 flex flex-col justify-between h-screen shrink-0 shadow-2xl lg:shadow-none">
        <div>
