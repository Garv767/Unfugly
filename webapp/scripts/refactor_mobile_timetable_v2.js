...
// Find the closing }; of the renderMobileTable block (which ends before desktop header)
const nextDesktopHeaderIndex = tv.indexOf('      {/* Desktop Header */}', startIndex);
const endIndex = tv.lastIndexOf('  };', nextDesktopHeaderIndex) + 4;
...
console.log('Successfully applied mobile render logic!');
