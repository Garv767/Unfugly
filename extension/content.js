    ...
    menuContainer.innerHTML = `
        ...
        ">
            ...
            <div style="display: flex; justify-content: center; gap: 28px; padding: 10px 16px; border-top: 1px solid #333; margin-top: 4px;">
                ...
                " onmouseover="this.querySelector('svg').setAttribute('fill', '#25D366')" onmouseout="this.querySelector('svg').setAttribute('fill', '#888')">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="#888" style="transition: fill 0.2s;">
                ...
                <a href="https://unfugly.app" target="_blank" title="Web App" style="
                    display: flex;
                    align-items: center;
                    text-decoration: none;
                " onmouseover="this.querySelector('svg').setAttribute('stroke', '#1E88E5')" onmouseout="this.querySelector('svg').setAttribute('stroke', '#888')">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition: stroke 0.2s;">
